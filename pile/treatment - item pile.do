...
foreach age of numlist 1 3 {
	...
	graph dot ehscenterRinsig ehscenterR0_1 ehscenterR0_05 ehscenterR0_01 ///
			  ...
			  ihdpRinsig ihdpR0_1 ihdpR0_05 ihdpR0_01 ///
			  abcRinsig abcR0_1 abcR0_05 abcR0_01, ///
	marker(1,msize(small) msymbol(D) mlc(red) mfc(red*0.05) mlw(vthin)) marker(2,msize(small) msymbol(D) mlc(red) mfc(red*0.5) mlw(vthin)) ///
	marker(3,msize(small) msymbol(D) mlc(red) mfc(red*0.75) mlw(vthin)) marker(4,msize(small) msymbol(D) mlc(red) mfc(red) mlw(vthin)) ///
	...
	marker(17,msize(small) msymbol(O) mlc(blue) mfc(blue*0.05) mlw(vthin)) marker(18,msize(small) msymbol(O) mlc(blue) mfc(blue*0.5) mlw(vthin)) ///
	marker(19,msize(small) msymbol(O) mlc(blue) mfc(blue*0.75) mlw(vthin)) marker(20,msize(small) msymbol(O) mlc(blue) mfc(blue) mlw(vthin)) ///
	over(question, label(labsize(tiny)) sort(scale_row)) ///
	legend (order (4 "EHS-Center" 8 "EHS-Home" 12 "EHS-Mixed" 16 "IHDP" 20 "ABC") size(vsmall)) yline(0) ylabel(#6, labsize(vsmall)) ///
