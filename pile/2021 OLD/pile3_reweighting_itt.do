...
* ------------------------------------------------- *
* ITT PILE PLOT WITH CI: CHOPPED AND REWEIGHTED 	*
* Author: Andrés                     				*	
* ------------------------------------------------- *
...
cd "$out"
	graph export "pile3_itt_chop_rew.pdf", replace
cd "$git_out"
	graph export "pile3_itt_chop_rew.pdf", replace
