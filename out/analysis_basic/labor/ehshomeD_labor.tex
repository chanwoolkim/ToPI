...
\noalign{\smallskip}\hline \noalign{\smallskip}Household Income &  &  & 4,177** & 1,953\\
 & \begin{footnotesize}\end{footnotesize} & \begin{footnotesize}\end{footnotesize} & \begin{footnotesize}(2,000)\end{footnotesize} & \begin{footnotesize}(2,758)\end{footnotesize}\\
