...
\noalign{\smallskip}\hline \noalign{\smallskip}Household Income &  &  & 2,962 & -971\\
 & \begin{footnotesize}\end{footnotesize} & \begin{footnotesize}\end{footnotesize} & \begin{footnotesize}(2,443)\end{footnotesize} & \begin{footnotesize}(2,478)\end{footnotesize}\\
