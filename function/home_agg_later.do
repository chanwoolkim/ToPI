...
replace scale = "Lack of Hostility" if scale_num == "3"
replace scale = "Learning Stimulation" if scale_num == "4"
replace scale = "Opportunities for Variety" if scale_num == "5"
...
replace scale_row = 7 if scale == "Total Score"
