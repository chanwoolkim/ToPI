...
\noalign{\smallskip}\hline \noalign{\smallskip}Household Income &  &  & 775 & -1,024\\
 & \begin{footnotesize}\end{footnotesize} & \begin{footnotesize}\end{footnotesize} & \begin{footnotesize}(1,325)\end{footnotesize} & \begin{footnotesize}(1,907)\end{footnotesize}\\
